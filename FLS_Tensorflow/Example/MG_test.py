...
FLS_TrainFun(16,4,LL,X_train,Y_train,X_test,Ypredict=Y_test,modeName='Mamdani',modeType=1,predictMode=False,\
    ...
    batchSIZE=16,epoch=10,useGPU=False,saveMode=False,outputModeName=None,modeSavePath=None)
