...
import sys
sys.path.append("..")
from Membership_Function.MembershipFunction_T2 import *
import tensorflow as tf
import numpy as np


class SingleT2FLS_TSK(tf.keras.Model):
    #构造函数__init__
    def __init__(self,FuzzyRuleNum,FuzzyAntecedentsNum,InitialSetup_List):
        super(SingleT2FLS_TSK,self).__init__()
